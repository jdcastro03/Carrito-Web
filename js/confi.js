...
function establecerImagenesChicas() {
    var imagenes = document.getElementsByTagName("img");
    for (var i = 0; i < imagenes.length; i++) {
        imagenes[i].style.width = "250px"; // Cambiar el ancho de la imagen
        imagenes[i].style.height = "250px"; // Cambiar la altura de la imagen
    }
...
function establecerImagenesMedianas() {
    var imagenes = document.getElementsByTagName("img");
    for (var i = 0; i < imagenes.length; i++) {
        imagenes[i].style.width = "400px"; // Cambiar el ancho de la imagen
        imagenes[i].style.height = "400px"; // Cambiar la altura de la imagen
    }
...
function establecerImagenesGrandes() {
    var imagenes = document.getElementsByTagName("img");
    for (var i = 0; i < imagenes.length; i++) {
        imagenes[i].style.width = "600px"; // Cambiar el ancho de la imagen
        imagenes[i].style.height = "600px"; // Cambiar la altura de la imagen
    }
